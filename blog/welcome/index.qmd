...
- **R and AI.** Ways in which coding agents can be used responsibly to assist with statistical programming, as well as general R tips and tricks.
- **Biostatistics and Clinical trials.** Adaptive designs, the gap between what is optimal on paper and what runs in practice, and what I learn along the way in the PhD.
- **General essays on what interests me.** Topics such as aviation, geopolitical history, or whatever else has my attention.
